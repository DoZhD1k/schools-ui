  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-slate-100 to-gray-100 relative">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative px-4 py-6 md:px-6 md:py-16">
          <div className="container mx-auto">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 lg:gap-0">
              <div className="max-w-3xl">
                <h1 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-2 md:mb-4 leading-tight">
                  {basicInfo.nameRu}
                </h1>
                <p className="text-sm md:text-xl text-white/90 mb-3 md:mb-4 leading-relaxed hidden sm:block">
                  {basicInfo.nameKz}
                </p>
                <div className="flex flex-wrap items-center gap-2 md:gap-4 text-white/90">
                  <div className="flex items-center space-x-1.5 bg-white/10 backdrop-blur-md rounded-full px-3 py-1.5 md:px-4 md:py-2 border border-[hsl(0_0%_100%_/_0.1)] shadow-sm">
                    <MapPin className="h-3.5 w-3.5 md:h-4 md:w-4" />
                    <span className="text-xs md:text-sm font-medium">
                      {basicInfo.district}
                    </span>
                  </div>
                  <div className="hidden sm:flex items-center space-x-1.5 bg-white/10 backdrop-blur-md rounded-full px-3 py-1.5 md:px-4 md:py-2 border border-[hsl(0_0%_100%_/_0.1)] shadow-sm">
                    <Building2 className="h-3.5 w-3.5 md:h-4 md:w-4" />
                    <span className="text-xs md:text-sm font-medium">
                      {basicInfo.organizationTypes}
                    </span>
                  </div>
                  <div className="hidden md:flex items-center space-x-1.5 bg-white/10 backdrop-blur-md rounded-full px-3 py-1.5 md:px-4 md:py-2 border border-[hsl(0_0%_100%_/_0.1)] shadow-sm">
              ...
              <div className="flex items-center gap-3 lg:flex-col lg:items-center lg:text-right">
                <div className="inline-flex items-center justify-center w-16 h-16 md:w-24 md:h-24 rounded-2xl md:rounded-3xl bg-white/10 backdrop-blur-md border border-[hsl(0_0%_100%_/_0.1)] shadow-lg">
                ...
                <Badge
                  ...
                  )} text-white border-0 text-xs md:text-sm px-3 py-1 md:px-4 md:py-2`}
                >
      ...
      <main className="relative mx-auto px-4 py-6 md:px-6 md:py-12 space-y-6 md:space-y-12">
        {/* Основная информация */}
        <div className="relative overflow-hidden">
          ...
          <div className="relative p-4 md:p-8">
            <h2 className="text-lg md:text-2xl font-bold text-slate-800 mb-4 md:mb-6 flex items-center">
              <div className="w-7 h-7 md:w-8 md:h-8 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-lg md:rounded-xl mr-2 md:mr-3 flex items-center justify-center">
                <Building2 className="h-4 w-4 md:h-5 md:w-5 text-white" />
              </div>
              Основная информация
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
              <div className="space-y-2 md:space-y-3 p-3 md:p-6 bg-slate-50/60 rounded-xl border border-slate-200/60">
                ...
                <p className="text-slate-600 ml-8 md:ml-12 text-xs md:text-base font-medium leading-relaxed">
                  {basicInfo.address}
                </p>
              </div>
                ...
                <div className="space-y-2 md:space-y-3 p-3 md:p-6 bg-slate-50/60 rounded-xl border border-slate-200/60">
                  <div className="flex items-center space-x-2 md:space-x-3">
                    <div className="p-1.5 md:p-2 bg-emerald-100 rounded-lg">
                      <Phone className="h-4 w-4 md:h-5 md:w-5 text-emerald-600" />
                    </div>
                    <span className="font-bold text-slate-900 text-sm md:text-base">
                      Телефон:
                    </span>
                  </div>
                  <p className="text-slate-600 ml-8 md:ml-12 text-xs md:text-base font-medium">
                    {basicInfo.phone}
                  </p>
                </div>
              )}
              ...
              <div className="space-y-2 md:space-y-3 p-3 md:p-6 bg-slate-50/60 rounded-xl border border-slate-200/60">
                <div className="flex items-center space-x-2 md:space-x-3">
                  <div className="p-1.5 md:p-2 bg-rose-100 rounded-lg">
                    <Users className="h-4 w-4 md:h-5 md:w-5 text-rose-600" />
                  </div>
                  <span className="font-bold text-slate-900 text-sm md:text-base">
                    Количество учащихся:
                  </span>
                </div>
                <p className="text-slate-600 ml-8 md:ml-12 text-xs md:text-base font-medium mb-2 md:mb-3">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative p-4 md:p-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
              <div className="p-3 md:p-6 bg-slate-50/60 rounded-xl border border-slate-200/60">
              ...
              <div className="flex items-center justify-center p-4 md:p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200/60">
                <div className="text-center">
                  <div className="flex items-center justify-center gap-2 md:gap-3 mb-3 md:mb-4">
                    <span className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
                      {qualityKnowledge.qualityRating}%
                    </span>
                    <div className="p-1.5 md:p-2 bg-white rounded-lg shadow-md">
                  ...
                  <p className="text-xs md:text-sm text-slate-500 mt-2 md:mt-3 font-medium bg-white px-3 py-1.5 md:px-4 md:py-2 rounded-lg">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative p-4 md:p-8">
            <h2 className="text-lg md:text-2xl font-bold text-slate-800 mb-4 md:mb-6 flex items-center">
              <div className="w-7 h-7 md:w-8 md:h-8 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-lg md:rounded-xl mr-2 md:mr-3 flex items-center justify-center">
                <TrendingUp className="h-4 w-4 md:h-5 md:w-5 text-white" />
              </div>
              Динамика результатов
            </h2>
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6">
              <div className="text-center p-3 md:p-6 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200/60">
                <div className="text-xl md:text-3xl font-bold text-blue-600 mb-1 md:mb-2">
                  {schoolResults.graduatesCount}
                </div>
                <p className="text-[10px] md:text-sm text-slate-600 font-semibold">
                  Выпускники
                </p>
              </div>

              <div className="text-center p-3 md:p-6 bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl border border-yellow-200/60">
              ...
              <div className="text-center p-3 md:p-6 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border border-green-200/60">
              ...
              <div className="text-center p-3 md:p-6 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border border-purple-200/60">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8">
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="relative p-4 md:p-8">
              <h2 className="text-base md:text-xl font-bold text-slate-800 mb-4 md:mb-6 flex items-center">
                <div className="w-6 h-6 md:w-7 md:h-7 bg-gradient-to-r from-amber-500 to-orange-500 rounded-lg mr-2 md:mr-3 flex items-center justify-center">
                  <Award className="h-3.5 w-3.5 md:h-4 md:w-4 text-white" />
                </div>
                Развитие талантов
              </h2>
              <div className="p-3 md:p-4 bg-slate-50/60 rounded-xl border border-slate-200/60">
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="relative p-4 md:p-8">
              <h2 className="text-base md:text-xl font-bold text-slate-800 mb-4 md:mb-6 flex items-center">
                <div className="w-6 h-6 md:w-7 md:h-7 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-lg mr-2 md:mr-3 flex items-center justify-center">
                  <User className="h-3.5 w-3.5 md:h-4 md:w-4 text-white" />
                </div>
                Педагогический состав
              </h2>

              <div className="mb-4 md:mb-6 p-3 md:p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200/60">
                <div className="flex items-center justify-between">
                  <div>
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative p-4 md:p-8">
            <h2 className="text-base md:text-xl font-bold text-slate-800 mb-4 md:mb-6 flex items-center">
              <div className="w-6 h-6 md:w-7 md:h-7 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg mr-2 md:mr-3 flex items-center justify-center">
                <Monitor className="h-3.5 w-3.5 md:h-4 md:w-4 text-white" />
              </div>
              Оснащенность школы
            </h2>
            ...
            <div className="grid grid-cols-3 gap-3 md:gap-6">
              ...
              <div className="text-center p-3 md:p-6 bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-xl border border-indigo-200/60">
                <div className="text-xl md:text-3xl font-bold text-indigo-600 mb-1 md:mb-2">
                  {schoolEquipment.newModificationClassrooms}
                </div>
                <p className="text-[10px] md:text-sm text-slate-600 font-semibold leading-tight">
                  Новых/модерниз.
                </p>
              </div>

              <div className="text-center p-3 md:p-6 bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl border border-pink-200/60">
                <div className="text-xl md:text-3xl font-bold text-pink-600 mb-1 md:mb-2">
            ...
            <div className="mt-4 md:mt-6 p-3 md:p-4 bg-slate-50/60 rounded-xl border border-slate-200/60">
              <div className="flex items-center justify-between mb-2 md:mb-3">
                <span className="text-xs md:text-base text-slate-800 font-medium">
              ...
              <Progress
                ...
                className="h-2 md:h-3 bg-slate-200"
              />
            </div>
          </div>
        </div>
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative p-4 md:p-8">
            <h2 className="text-base md:text-xl font-bold text-slate-800 mb-4 md:mb-6 flex items-center">
              <div className="w-6 h-6 md:w-7 md:h-7 bg-gradient-to-r from-red-500 to-orange-500 rounded-lg mr-2 md:mr-3 flex items-center justify-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 md:gap-6">
              <div className="flex items-center justify-between p-3 md:p-4 bg-slate-50/60 rounded-xl border border-slate-200/60">
                <div className="flex items-center space-x-2 md:space-x-3">
                  <div
            ...
            <div className="mt-4 md:mt-6 p-3 md:p-4 bg-gradient-to-r from-red-50 to-orange-50 rounded-xl border border-red-200/60">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm md:text-lg font-bold text-slate-800">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative p-4 md:p-8">
            <h2 className="text-base md:text-xl font-bold text-slate-800 mb-4 md:mb-6 flex items-center">
              <div className="w-6 h-6 md:w-7 md:h-7 bg-gradient-to-r from-green-500 to-teal-500 rounded-lg mr-2 md:mr-3 flex items-center justify-center">
                <Award className="h-3.5 w-3.5 md:h-4 md:w-4 text-white" />
              </div>
              Международные отношения
            </h2>
            ...
            <div className="grid grid-cols-2 gap-3 md:gap-6">
              ...
              <div className="text-center p-3 md:p-6 bg-gradient-to-br from-teal-50 to-teal-100 rounded-xl border border-teal-200/60">
            ...
            <div className="mt-4 md:mt-6 p-3 md:p-4 bg-gradient-to-r from-green-50 to-teal-50 rounded-xl border border-green-200/60">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm md:text-lg font-bold text-slate-800">
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="relative p-4 md:p-6">
              <Button
                ...
                className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-5 py-2 md:px-8 md:py-3 text-sm md:text-lg font-semibold"
              >
